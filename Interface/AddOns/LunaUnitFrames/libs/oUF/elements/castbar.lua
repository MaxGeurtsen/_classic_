...
local origUnitCastingInfo = UnitCastingInfo
local origUnitChannelInfo = UnitChannelInfo
local UnitCastingInfo
local UnitChannelInfo
-- Man i love transitioning periods
if build <= 20502 then
	UnitCastingInfo = function(unit)
						local name, arg, texture, startTime, endTime, isTradeSkill, castID, spellID = origUnitCastingInfo(unit)
						return name, arg, texture, startTime, endTime, isTradeSkill, castID, nil, spellID
					end
	UnitChannelInfo = function(unit)
						local name, arg, texture, startTime, endTime, isTradeSkill, spellID = origUnitChannelInfo(unit)
						return name, arg, texture, startTime, endTime, isTradeSkill, nil, spellID
					end
else
	UnitCastingInfo = origUnitCastingInfo
	UnitChannelInfo = origUnitChannelInfo
end
