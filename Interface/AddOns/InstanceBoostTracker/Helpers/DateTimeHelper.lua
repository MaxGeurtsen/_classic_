...
function DateTimeHelper:FromTable(value)
  return date:__call(value.year, value.month, value.day, value.hour, value.minute, value.second)
end

function DateTimeHelper:NowSplitObj()
  local obj = {
      year = osdate("20%y"),
      month = osdate("%m"),
      day = osdate("%d"),
